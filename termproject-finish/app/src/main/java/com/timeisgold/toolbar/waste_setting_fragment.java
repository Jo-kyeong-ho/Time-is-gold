...
public class waste_setting_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.waste_setting_fragment, container, false);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    String SQL="insert into wastetable(workname, value) values ('" + name+"',"+val+")";
                    db.execSQL(SQL);
                    ...
                    Toast.makeText(getActivity(),"돈에 숫자를 입력하세요",Toast.LENGTH_LONG).show();
                }
            }
        });
        return rootView;
