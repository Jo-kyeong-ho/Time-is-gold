...
public class TimerValue extends FragmentActivity {
    ...
    int limit = 0;
    Button button;
    @Override protected void onActivityResult(int reque, int result, Intent intent) {
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timer_value);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(TimerValue.this, ResultValue.class);
                    dodo = false;
            ...
            while (dodo) {
                ...
                try {
                    ...
                    if (time % limit == 0 && go == true) {
                        Intent intent = new Intent(TimerValue.this, TimePopup.class);
